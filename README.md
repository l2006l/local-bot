...
> # 权限说明
>
> 超管：主要是一些核心功能，比如全部同步，同步某个群聊的文件等可能对系统造成较大影响的功能，需要该权限才能使用
>
> 白名单群：白名单群内的用户（除黑名单用户外），可以使用搜索，翻页，下载等基础功能
>
> 自动上传：可以设置个人qq账号或者群号，如果是群号，则可以实现监听群内所有文建上传操作并自动同步到本地
>
> 白名单用户：可以使用删除指令，对文件进行删除
>
> 黑名单用户：不允许使用任何指令
